...
class ProviderRouter:
    ...
    def automatic(self, groq_model=None, openrouter_model=None, nvidia_model=None, mistral_model=None):
        return AutomaticAgent(self.tool_executor, groq_model, openrouter_model, nvidia_model, mistral_model)


class AutomaticAgent:
    def __init__(self, tool_executor, groq_model=None, openrouter_model=None, nvidia_model=None, mistral_model=None):
        self.tool_executor = tool_executor
